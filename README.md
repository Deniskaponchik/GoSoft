...
<div align="left">
  <img alt="LDAP auth" src="https://github.com/Deniskaponchik/GoSoft/blob/main/web/png/ldap.PNG" width="600"/>
</div>
...
| HTTP server    | [GIN](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/controller/http/fokInterface) <br/> [LDAP Authentication](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/authentication) <br/> [jwt tokens](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/authorization)                                               |
| GRPC           | [Proto](https://github.com/Deniskaponchik/GoSoft/tree/main/api/unifi/v1) <br/> [Server](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/controller/grpc/my) <br/> [Client](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/api_grpc)                                                                                                |
| RabbitMQ       | [Server](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/controller/http/fokInterface) <br/> [Client](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/ldap)                                                                                                                                                                         |
| API            | [SOAP](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/api_soap) <br/> [REST](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/api_rest) <br/> [WEB](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/api_web) <br/> [GRPC](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/api_grpc) |
| Repository     | [MySQL](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/repo) [Redis](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/repo) [ORM](https://github.com/Deniskaponchik/GoSoft/tree/main/internal/usecase/repo)                                                                                                                |
...
| Clients        | При обработке каждого клиента информация заносится в 2 мапы: по маку и по имени машины.                                                                                                                                                                                                                                                                             |
