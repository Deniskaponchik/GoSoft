...
func main4334534534() {
	//proPing("10.21.178.157")
	//proPing("10.57.178.44")
	//unixPing("10.57.178.44")
	//unixPing("10.21.178.157")
	//exampleMy("10.57.178.44")
	exampleMy("10.21.178.157")
}

func proPing(ipString string) {
	...
	//pinger.OnDuplicateRecv = func() {		fmt.Sprintln()	}
...
func exampleMy(ipString string) {
	host := ipString
