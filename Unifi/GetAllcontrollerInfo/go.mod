...
//replace golang.org/x/crypto@v0.10.0: Get "https://proxy.golang.org/golang.org/x/crypto/@v/v0.10.0.info"
//replace golang.org/x/term@v0.9.0: Get "https://proxy.golang.org/golang.org/x/term/@v/v0.9.0.info"
//replace golang.org/x/text@v0.10.0: Get "https://proxy.golang.org/golang.org/x/text/@v/v0.10.0.info":
