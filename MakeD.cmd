...
rem go build -o ..\..\bin\Unifi_v3.28-PROD -ldflags="-s -w"
rem go build -o ..\..\bin\Unifi_v3.29-PROD -ldflags="-s -w"
rem )
...
rem start /B bin/Unifi_v3.28-PROD -mode PROD -time +5
    start /B bin/Unifi_v3.29-PROD -mode PROD -time +5
rem )
